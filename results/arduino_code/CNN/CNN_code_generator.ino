...
void setup() {
  ...
  Serial.println("Initializing the neural network...");

  // Initialize the neural network
  setup_network();

  Serial.println("Running inference benchmark...");
  ...
  // -------------------------------------------------
  // Warm-up inference (not included in timing average)
  // -------------------------------------------------
  predictions = predict(input);
  delete[] predictions;

  // -------------------------------------------------
  // Perform multiple inference runs for benchmarking
  // -------------------------------------------------
  ...
  // -------------------------------------------------
  // Final inference for result interpretation
  // -------------------------------------------------
  predictions = predict(input);

  Serial.println("Output probabilities (classes 0-11):");

  int predicted_class = -1;
  float max_prob = -1.0;

  // Iterate over output classes (assumed 12)
  for (int i = 0; i < 12; i++) {
    Serial.print("Class ");
    Serial.print(i);
    Serial.print(": ");
  ...
  // Print confidence (maximum probability)
...
// Arduino loop function (not used)
void loop() {
